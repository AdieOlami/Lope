#
#  Be sure to run `pod spec lint Lope.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  This library helps you perfom sliding actions
                   DESC
  ...
  spec.source       = { :git => "https://github.com/AdieOlami/Lope.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Lope/**/*.{h,m,swift}"
  # , 'Classes/*', 'Resource/*'
